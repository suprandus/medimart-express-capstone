      ...
      {{-- <li class="dropdown dropdown-list-toggle">
        ...
        <div class="dropdown-menu dropdown-list dropdown-menu-right">
          ...
          <div class="dropdown-list-content dropdown-list-icons">
            ...
            <a href="{{ route('admin.order.show', $notification->id) }}" class="dropdown-item dropdown-item-unread">
            ...
            <a href="{{ route('admin.products.edit', $notification->id) }}" class="dropdown-item dropdown-item-unread">
