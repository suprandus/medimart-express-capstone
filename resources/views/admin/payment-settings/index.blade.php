            ...
            <div class="row">
              ...
              <div class="col-2">
                ...
                <div class="list-group" id="list-tab" role="tablist">
                  <a class="list-group-item list-group-item-action active" id="list-paymongo-list" data-toggle="list"
                    href="#list-paymongo" role="tab">PayMongo</a>
              ...
              <div class="col-10">
                <div class="tab-content" id="nav-tabContent">
                  ...
                  @include('admin.payment-settings.sections.paymongo-setting')
