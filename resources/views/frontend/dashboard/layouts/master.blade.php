...
<head>
    ...
    <link rel="stylesheet" href="{{asset('frontend/assets/modules/weather-icon/css/weather-icons.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/assets/modules/weather-icon/css/weather-icons-wind.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('frontend/assets/css/bootstrap-iconpicker.min.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/assets/modules/bootstrap-daterangepicker/daterangepicker.css')}}">
    <link rel="stylesheet" href="{{asset('frontend/assets/modules/select2/dist/css/select2.min.css')}}">
...
<body>
    ...
    <script src="{{asset('frontend/assets/modules/jqvmap/dist/jquery.vmap.min.js')}}"></script>
    <script src="{{asset('frontend/assets/modules/jqvmap/dist/maps/jquery.vmap.world.js')}}"></script>
    ...
    <script src="{{asset('frontend/assets/js/bootstrap-iconpicker.bundle.min.js')}}"></script>
    <script src="{{asset('frontend/assets/modules/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
    <script src="{{asset('frontend/assets/modules/select2/dist/js/select2.full.min.js')}}"></script>

    <!-- Page Specific JS File -->
    {{-- <script src="{{asset('frontend/assets/js/page/index-0.js')}}"></script> --}}
