                        ...
                        <a class="wsus__hot_deals__single" href="{{route('product-detail', $item->slug)}}">
                            ...
                            <div class="wsus__hot_deals__single_text mt-2">
                                ...
                                <p class="wsus__rating">
                                    ...
                                    @for ($i = 1; $i <= 5; $i++) @if ($i <=$item->reviews_avg_rating)
                                ...
                                <p class="wsus__tk">{{$settings->currency_icon}}{{number_format($item->offer_price, 2)}}
                                    <del>{{$settings->currency_icon}}{{number_format($item->price, 2)}}</del>
                                </p>
                                @else
                                <p class="wsus__tk">{{$settings->currency_icon}}{{number_format($item->price, 2)}}</p>
                                @endif
                            </div>
                        </a>
                    </div>
