...
<div id="nearbypharmacycontainer">
    <form action="{{ route('nearest-vendors') }}" method="POST">
        ...
        <div class="form-group">
            <p style="text-align: center; font-size:30px; font-weight: bold;">Search for Nearest Pharmacy</p>
            ...
            <div class="mb-2 d-flex">
                ...
                <!-- Submit Button -->
                <input type="submit" value="Search Near Pharmacy" class="btn btn-primary">
            </div>
   ...
   <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBFfWKWjTQueC1E9sqRwJ9E1igYRM5zNYE&libraries=places&callback=initMap" async defer></script>          </div>
    </form>
        ...
        <div class="mt-4 text-center">
            ...
            <div class="row">
                @foreach ($vendors as $vendor)
                    <div class="col-xl-6 col-md-6"> <!-- Each vendor takes half the width -->
                        <div class="wsus__vendor_single">
                            ...
                            <div class="wsus__vendor_text">
                                <div class="wsus__vendor_text_center text-start">
                                    ...
                                    <a href="javascript:;"><i class="fal fa-map-marker-alt"></i> {{ $vendor->address }}</a>
    ...
    @else
        <p class="mt-4" style="text-align: center; font-size: 1.2rem; font-weight: bold;">No nearby pharmacies found.</p>
    @endif
</div>
@endsection
