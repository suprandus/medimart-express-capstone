            ...
            <div class="col-xl-12">
                <div class="wsus__pro_page_bammer">
                    ...
                    <a href="{{$productpage_banner_section->banner_one->banner_url}}">
                        <img class="img-gluid" src="{{asset($productpage_banner_section->banner_one->banner_image)}}"
                            alt="">
                    </a>
                    @endif
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="wsus__product_item">
                                        ...
                                        <span class="wsus__minus">-{{calculateDiscountPercent($product->price,
                                        ...
                                        <div class="wsus__product_details">
                                            ...
                                            <p class="wsus__pro_rating">
                                                ...
                                                @for ($i = 1; $i <= 5; $i++) @if ($i <=$product->ratings_avg_review)
                                            ...
                                            <a class="wsus__pro_name"
                                                href="{{route('product-detail', $product->slug)}}">{{limitText($product->name,
                                                53)}}</a>
                                            @if(checkDiscount($product))
                                            <p class="wsus__price">
                                                {{$settings->currency_icon}}{{number_format($product->offer_price, 2)}}
                                                <del>{{$settings->currency_icon}}{{number_format($product->price,
                                                    2)}}</del>
                                            </p>
                                            @else
                                            <p class="wsus__price">
                                                {{$settings->currency_icon}}{{number_format($product->price, 2)}}</p>
                                            @endif
                                            <form class="shopping-cart-form">
                                                ...
                                                <select class="d-none" name="variants_items[]">
                                                    ...
                                                    <option value="{{$variantItem->id}}" {{$variantItem->is_default == 1
                                                        ? 'selected' : ''}}>{{$variantItem->name}}
                                                        (${{number_format($variantItem->price, 2)}})</option>
                                                    @endif
                                                    @endforeach
                                                </select>
                                                @endif
                                    ...
                                    <div class="wsus__product_item wsus__list_view">
                                        ...
                                        <div class="wsus__product_details">
                                            ...
                                            <p class="wsus__pro_rating">
                                                ...
                                                @for ($i = 1; $i <= 5; $i++) @if ($i <=$product->reviews_avg_rating)
                                                    <i class="fas fa-star"></i>
                                                    @else
                                                    <i class="far fa-star"></i>
                                                    @endif
